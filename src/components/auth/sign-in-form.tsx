...
export function SignInForm() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2">
      {/* Left: Form */}
      <div className="flex flex-col justify-between px-5 py-10 md:px-12 lg:px-20">
        <div>
        ...
        <div className="hidden md:flex gap-6 pt-8 border-t border-border mt-8">
          {[
            ...
            <div
              key={text}
              className="flex items-center gap-2 text-label text-text-secondary"
            >
      ...
      {/* Right: Hero visual — abstract gradient (OpenAI style) */}
      <div className="hidden md:block relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-neutral-50 via-stone-100 to-neutral-200" />
        {/* Decorative orb */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative">
            <div className="w-72 h-72 rounded-full bg-gradient-to-br from-neutral-300/50 to-neutral-400/20 blur-3xl" />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-36 h-36 rounded-full bg-gradient-to-br from-neutral-100 to-white border border-neutral-200/50 shadow-lg" />
            </div>
          </div>
        </div>
        {/* Subtle dot pattern */}
